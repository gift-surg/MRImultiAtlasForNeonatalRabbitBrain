...
export IMG_INPUT=(`ls subjects_bimodal/*.nii.gz`)
echo $IMG_INPUT
export IMG_INPUT_MASK=(`ls masks_bimodal/*.nii.gz`) # leave empty to not use floating masks
echo $IMG_INPUT_MASK
...
export TEMPLATE='subjects_bimodal/1305_bimodal.nii.gz'
export TEMPLATE_MASK='masks_bimodal/1305_mask.nii.gz'

# folder where the result images will be saved
export RES_FOLDER='results_bimodal'
...
export NRR_args=" -ln 4 -lp 2 -be 0.8 -vel -omp 8 "
