...
if __name__ == '__main__':
    ...
    target_name = '<IN VIVO SUBJECT NAME HERE>'
    spot_sj = SpotDS(atlas_pfo=jph(root_rabbit, 'A_atlas'),  # here path to the folder with the atlas.
                     target_pfo=jph(root_rabbit, 'A_data/PTB/in_vivo/{0}/stereotaxic'.format(target_name)),
                     target_name=target_name,
                     parameters_tag='InVivo')
    ...
    spot_sj.propagation_options['N_rigid_parameters']       = '  -vel -be 0.5 -ln 6 -lp 4  -smooR 1.5 -smooF 1.5 '
