...
if __name__ == '__main__':
    ...
    df_measures_man1_man2_taxo = pa.read_pickle(ph.pfi_pickled_scoring_man1_man2_all)
    df_measures_auto_man1_taxo = pa.read_pickle(ph.pfi_pickled_scoring_auto_man1_all)
    df_measures_auto_man2_taxo = pa.read_pickle(ph.pfi_pickled_scoring_auto_man2_all)
    ...
    ax[0].set_ylabel('%')
    ax[0].set_ylim([-0.001, 0.0450])  # set manually for easy comparisons between figures.
    ...
    ax[1].set_ylabel('mm')
    ax[1].set_ylim([-0.001, 0.12])  # set manually for easy comparisons between figures.
