...
def run_separate_brain_regions(controller):
    ...
    for sj in path_manager.atlas_subjects:
        ...
        if controller['Divide_manual_segm']:
            ...
            nis_app = nis.App()
            nis_app.manipulate_labels.relabel(pfi_segm_manual, pfi_segm_manual_divided_nomenclature,
        ...
        if controller['Divide_automatic_segm']:
            ...
            for segm_suffix in param.segm_suffix:
                name_segm = '{0}_{1}_{2}'.format(sj, segm_suffix, param.segm_tags)
                ...
                if controller['verbose']:
                    ...
                    nis_app = nis.App()
                    nis_app.manipulate_labels.relabel(pfi_segm_automatic, pfi_segm_automatic_divided_by_nomenclature,
                                                      list_old_labels=nomenclature_old_labels,
                                                      list_new_labels=nomenclature_new_labels)
